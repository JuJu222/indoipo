async function seedCompanies(prisma) {
    ...
    await prisma.company.upsert({
        ...
        create: {
            ...
            ticker: 'SURI',
            img: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/indoipo/img/SURI.jpg',
            ...
            date_umum_start: new Date("2023-11-23"),
            date_umum_end: new Date("2023-11-27"),
            date_penjatahan: new Date("2023-11-27"),
            date_distribusi: new Date("2023-11-28"),
