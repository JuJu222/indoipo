                        ...
                        <div className='flex md:space-x-10 flex-col md:flex-row'>
                            ...
                            <div className='w-full md:w-2/3 py-6 md:p-0'>
                                ...
                                <div
                                    ...
                                    {company.prospectus_summary_url ? (
                                        ...
                                        <div
                                           className="inline-block px-4 py-2 text-sm font-medium text-gray-300 bg-gray-50 focus:relative border-l border-r flex gap-2 items-center justify-center transition">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                                 className="bi bi-file-earmark-arrow-down" viewBox="0 0 16 16">
                                                <path
                                                    d="M8.5 6.5a.5.5 0 0 0-1 0v3.793L6.354 9.146a.5.5 0 1 0-.708.708l2 2a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L8.5 10.293V6.5z"/>
